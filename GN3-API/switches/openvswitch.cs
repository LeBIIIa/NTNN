...
namespace GNS3_API
{
    ...
    public class OpenvSwitch : Switch{
        ...
        private const string label = "OVS";
        /// <summary>
        ...
        internal OpenvSwitch(string _consoleHost, ushort _port, string _name, string _id, Status status, GNS3sharp parent,
